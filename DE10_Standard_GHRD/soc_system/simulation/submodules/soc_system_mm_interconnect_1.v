...
module soc_system_mm_interconnect_1 (
		...
		output wire [9:0]  Instruction_Mem_s1_address,                                          //                                            Instruction_Mem_s1.address
		output wire        Instruction_Mem_s1_write,                                            //                                                              .write
		input  wire [31:0] Instruction_Mem_s1_readdata,                                         //                                                              .readdata
		output wire [31:0] Instruction_Mem_s1_writedata,                                        //                                                              .writedata
		output wire [3:0]  Instruction_Mem_s1_byteenable,                                       //                                                              .byteenable
		output wire        Instruction_Mem_s1_chipselect,                                       //                                                              .chipselect
		output wire        Instruction_Mem_s1_clken,                                            //                                                              .clken
	...
	wire   [31:0] instruction_mem_s1_agent_m0_readdata;                     // Instruction_Mem_s1_translator:uav_readdata -> Instruction_Mem_s1_agent:m0_readdata
	wire          instruction_mem_s1_agent_m0_waitrequest;                  // Instruction_Mem_s1_translator:uav_waitrequest -> Instruction_Mem_s1_agent:m0_waitrequest
	wire          instruction_mem_s1_agent_m0_debugaccess;                  // Instruction_Mem_s1_agent:m0_debugaccess -> Instruction_Mem_s1_translator:uav_debugaccess
	wire   [20:0] instruction_mem_s1_agent_m0_address;                      // Instruction_Mem_s1_agent:m0_address -> Instruction_Mem_s1_translator:uav_address
	wire    [3:0] instruction_mem_s1_agent_m0_byteenable;                   // Instruction_Mem_s1_agent:m0_byteenable -> Instruction_Mem_s1_translator:uav_byteenable
	wire          instruction_mem_s1_agent_m0_read;                         // Instruction_Mem_s1_agent:m0_read -> Instruction_Mem_s1_translator:uav_read
	wire          instruction_mem_s1_agent_m0_readdatavalid;                // Instruction_Mem_s1_translator:uav_readdatavalid -> Instruction_Mem_s1_agent:m0_readdatavalid
	wire          instruction_mem_s1_agent_m0_lock;                         // Instruction_Mem_s1_agent:m0_lock -> Instruction_Mem_s1_translator:uav_lock
	wire   [31:0] instruction_mem_s1_agent_m0_writedata;                    // Instruction_Mem_s1_agent:m0_writedata -> Instruction_Mem_s1_translator:uav_writedata
	wire          instruction_mem_s1_agent_m0_write;                        // Instruction_Mem_s1_agent:m0_write -> Instruction_Mem_s1_translator:uav_write
	wire    [2:0] instruction_mem_s1_agent_m0_burstcount;                   // Instruction_Mem_s1_agent:m0_burstcount -> Instruction_Mem_s1_translator:uav_burstcount
	wire          instruction_mem_s1_agent_rf_source_valid;                 // Instruction_Mem_s1_agent:rf_source_valid -> Instruction_Mem_s1_agent_rsp_fifo:in_valid
	wire  [112:0] instruction_mem_s1_agent_rf_source_data;                  // Instruction_Mem_s1_agent:rf_source_data -> Instruction_Mem_s1_agent_rsp_fifo:in_data
	wire          instruction_mem_s1_agent_rf_source_ready;                 // Instruction_Mem_s1_agent_rsp_fifo:in_ready -> Instruction_Mem_s1_agent:rf_source_ready
	wire          instruction_mem_s1_agent_rf_source_startofpacket;         // Instruction_Mem_s1_agent:rf_source_startofpacket -> Instruction_Mem_s1_agent_rsp_fifo:in_startofpacket
	wire          instruction_mem_s1_agent_rf_source_endofpacket;           // Instruction_Mem_s1_agent:rf_source_endofpacket -> Instruction_Mem_s1_agent_rsp_fifo:in_endofpacket
	wire          instruction_mem_s1_agent_rsp_fifo_out_valid;              // Instruction_Mem_s1_agent_rsp_fifo:out_valid -> Instruction_Mem_s1_agent:rf_sink_valid
	wire  [112:0] instruction_mem_s1_agent_rsp_fifo_out_data;               // Instruction_Mem_s1_agent_rsp_fifo:out_data -> Instruction_Mem_s1_agent:rf_sink_data
	wire          instruction_mem_s1_agent_rsp_fifo_out_ready;              // Instruction_Mem_s1_agent:rf_sink_ready -> Instruction_Mem_s1_agent_rsp_fifo:out_ready
	wire          instruction_mem_s1_agent_rsp_fifo_out_startofpacket;      // Instruction_Mem_s1_agent_rsp_fifo:out_startofpacket -> Instruction_Mem_s1_agent:rf_sink_startofpacket
	wire          instruction_mem_s1_agent_rsp_fifo_out_endofpacket;        // Instruction_Mem_s1_agent_rsp_fifo:out_endofpacket -> Instruction_Mem_s1_agent:rf_sink_endofpacket
	wire          instruction_mem_s1_agent_rdata_fifo_src_valid;            // Instruction_Mem_s1_agent:rdata_fifo_src_valid -> Instruction_Mem_s1_agent_rdata_fifo:in_valid
	wire   [33:0] instruction_mem_s1_agent_rdata_fifo_src_data;             // Instruction_Mem_s1_agent:rdata_fifo_src_data -> Instruction_Mem_s1_agent_rdata_fifo:in_data
	wire          instruction_mem_s1_agent_rdata_fifo_src_ready;            // Instruction_Mem_s1_agent_rdata_fifo:in_ready -> Instruction_Mem_s1_agent:rdata_fifo_src_ready
	...
	wire          instruction_mem_s1_agent_rp_valid;                        // Instruction_Mem_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] instruction_mem_s1_agent_rp_data;                         // Instruction_Mem_s1_agent:rp_data -> router_003:sink_data
	wire          instruction_mem_s1_agent_rp_ready;                        // router_003:sink_ready -> Instruction_Mem_s1_agent:rp_ready
	wire          instruction_mem_s1_agent_rp_startofpacket;                // Instruction_Mem_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          instruction_mem_s1_agent_rp_endofpacket;                  // Instruction_Mem_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> Instruction_Mem_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> Instruction_Mem_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // Instruction_Mem_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> Instruction_Mem_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> Instruction_Mem_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> Instruction_Mem_s1_burst_adapter:sink0_endofpacket
	wire          instruction_mem_s1_burst_adapter_source0_valid;           // Instruction_Mem_s1_burst_adapter:source0_valid -> Instruction_Mem_s1_agent:cp_valid
	wire  [111:0] instruction_mem_s1_burst_adapter_source0_data;            // Instruction_Mem_s1_burst_adapter:source0_data -> Instruction_Mem_s1_agent:cp_data
	wire          instruction_mem_s1_burst_adapter_source0_ready;           // Instruction_Mem_s1_agent:cp_ready -> Instruction_Mem_s1_burst_adapter:source0_ready
	wire    [1:0] instruction_mem_s1_burst_adapter_source0_channel;         // Instruction_Mem_s1_burst_adapter:source0_channel -> Instruction_Mem_s1_agent:cp_channel
	wire          instruction_mem_s1_burst_adapter_source0_startofpacket;   // Instruction_Mem_s1_burst_adapter:source0_startofpacket -> Instruction_Mem_s1_agent:cp_startofpacket
	wire          instruction_mem_s1_burst_adapter_source0_endofpacket;     // Instruction_Mem_s1_burst_adapter:source0_endofpacket -> Instruction_Mem_s1_agent:cp_endofpacket
	...
	wire          instruction_mem_s1_agent_rdata_fifo_out_valid;            // Instruction_Mem_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] instruction_mem_s1_agent_rdata_fifo_out_data;             // Instruction_Mem_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          instruction_mem_s1_agent_rdata_fifo_out_ready;            // avalon_st_adapter_001:in_0_ready -> Instruction_Mem_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> Instruction_Mem_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> Instruction_Mem_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // Instruction_Mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> Instruction_Mem_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) instruction_mem_s1_translator (
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (led_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (instruction_mem_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (instruction_mem_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (instruction_mem_s1_agent_m0_read),          //                         .read
		.uav_write              (instruction_mem_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (instruction_mem_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (instruction_mem_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (instruction_mem_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (instruction_mem_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (instruction_mem_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (instruction_mem_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (instruction_mem_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Instruction_Mem_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (Instruction_Mem_s1_write),                  //                         .write
		.av_readdata            (Instruction_Mem_s1_readdata),               //                         .readdata
		.av_writedata           (Instruction_Mem_s1_writedata),              //                         .writedata
		.av_byteenable          (Instruction_Mem_s1_byteenable),             //                         .byteenable
		.av_chipselect          (Instruction_Mem_s1_chipselect),             //                         .chipselect
		.av_clken               (Instruction_Mem_s1_clken),                  //                         .clken
		.av_read                (),                                          //              (terminated)
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) instruction_mem_s1_agent (
		.clk                     (clk_0_clk_clk),                                          //             clk.clk
		.reset                   (led_pio_reset_reset_bridge_in_reset_reset),              //       clk_reset.reset
		.m0_address              (instruction_mem_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (instruction_mem_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (instruction_mem_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (instruction_mem_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (instruction_mem_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (instruction_mem_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (instruction_mem_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (instruction_mem_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (instruction_mem_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (instruction_mem_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (instruction_mem_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (instruction_mem_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (instruction_mem_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (instruction_mem_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (instruction_mem_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (instruction_mem_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (instruction_mem_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (instruction_mem_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (instruction_mem_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (instruction_mem_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (instruction_mem_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (instruction_mem_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (instruction_mem_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (instruction_mem_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (instruction_mem_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (instruction_mem_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (instruction_mem_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (instruction_mem_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (instruction_mem_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (instruction_mem_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (instruction_mem_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (instruction_mem_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                      // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                      //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                       //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                      //                .error
		.rdata_fifo_src_ready    (instruction_mem_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (instruction_mem_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (instruction_mem_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                  //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                    //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) instruction_mem_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (led_pio_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.in_data           (instruction_mem_s1_agent_rf_source_data),             //        in.data
		.in_valid          (instruction_mem_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (instruction_mem_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (instruction_mem_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (instruction_mem_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (instruction_mem_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (instruction_mem_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (instruction_mem_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (instruction_mem_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (instruction_mem_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) instruction_mem_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (led_pio_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (instruction_mem_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (instruction_mem_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (instruction_mem_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (instruction_mem_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (instruction_mem_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (instruction_mem_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	soc_system_mm_interconnect_1_router_002 router_003 (
		.sink_ready         (instruction_mem_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (instruction_mem_s1_agent_rp_valid),         //          .valid
		.sink_data          (instruction_mem_s1_agent_rp_data),          //          .data
		.sink_startofpacket (instruction_mem_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (instruction_mem_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) instruction_mem_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                          //       cr0.clk
		.reset                 (led_pio_reset_reset_bridge_in_reset_reset),              // cr0_reset.reset
		...
		.source0_valid         (instruction_mem_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (instruction_mem_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (instruction_mem_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (instruction_mem_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (instruction_mem_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (instruction_mem_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (led_pio_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (instruction_mem_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (instruction_mem_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (instruction_mem_s1_agent_rdata_fifo_out_ready), //         .ready
