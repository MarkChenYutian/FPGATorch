//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=16 LPM_WIDTHB=17 LPM_WIDTHP=33 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_il01
	...
	wire	[7:0]	wire_add17_result;
	wire	[31:0]	wire_add2_result;
	wire	[23:0]	wire_add7_result;
	...
	wire  [23:0]   wire_sft10a_in;
	wire  [23:0]   wire_sft10a_out;
	wire  [23:0]   wire_sft11a_in;
	wire  [23:0]   wire_sft11a_out;
	...
	wire  [15:0]   wire_sft16a_in;
	wire  [15:0]   wire_sft16a_out;
	wire  [7:0]   wire_sft18a_in;
	wire  [7:0]   wire_sft18a_out;
	wire  [7:0]   wire_sft19a_in;
	wire  [7:0]   wire_sft19a_out;
	wire  [7:0]   wire_sft20a_in;
	wire  [7:0]   wire_sft20a_out;
	wire  [7:0]   wire_sft21a_in;
	wire  [7:0]   wire_sft21a_out;
	wire  [31:0]   wire_sft3a_in;
	wire  [31:0]   wire_sft3a_out;
	wire  [31:0]   wire_sft4a_in;
	wire  [31:0]   wire_sft4a_out;
	wire  [31:0]   wire_sft5a_in;
	wire  [31:0]   wire_sft5a_out;
	wire  [31:0]   wire_sft6a_in;
	wire  [31:0]   wire_sft6a_out;
	wire  [23:0]   wire_sft8a_in;
	wire  [23:0]   wire_sft8a_out;
	wire  [23:0]   wire_sft9a_in;
	wire  [23:0]   wire_sft9a_out;
	wire  [16:0]  dataa_node;
	wire  [15:0]  datab_node;
	wire  [32:0]  final_result_node;
	wire  w419w;
	wire  [33:0]  w738w;
	wire  [271:0]  w_decoder_node9w;
	...
	assign
		wire_sft10a_in = {w419w, {w419w, {w419w, {w419w, {w_sum_node10w[93], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {2{w419w}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w419w, {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96:95]}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w419w, {w419w, {w419w, {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28:27]}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w419w, {w419w, {w419w, {w419w, {w_sum_node10w[55], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[115], {w_sum_node10w[114], {2{w419w}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w419w, {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134:133]}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w419w, {w419w, {w419w, {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w419w, {w419w, {w419w, {w419w, {w419w, {w419w, {2{w419w}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft3a_in = {w419w, {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[94], {w_sum_node10w[110], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[56], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft5a_in = {w419w, {w419w, {w419w, {w419w, {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft16a_out[15], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft21a_out[7], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[39], {w_sum_node10w[38], {2{w419w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w419w, {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58:57]}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w419w, {w419w, {w419w, {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41:40]}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[16:0]},
		datab_node = {dataa[15:0]},
		final_result_node = {w738w[32:0]},
		result = {final_result_node[32:0]},
		w419w = 1'b0,
		w738w = {wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
