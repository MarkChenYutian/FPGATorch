...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow zero
...
module  mult_cycle_6_altfp_mult_naq
	( 
	clock,
	dataa,
	datab,
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   zero_ff <= (((exp_is_zero | (~ input_not_zero_ff2)) & (~ input_is_nan_ff2)) & (~ input_is_infinity_ff2));
	...
	assign
		...
		zero = zero_ff;
endmodule //mult_cycle_6_altfp_mult_naq
//VALID FILE
...
module mult_cycle_6 (
	...
	mult_cycle_6_altfp_mult_naq	mult_cycle_6_altfp_mult_naq_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mult_cycle_6.cmp FALSE TRUE
