...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="SUB" OPTIMIZE="AREA" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow zero
//VERSION_BEGIN 16.1 cbx_altbarrel_shift 2017:01:11:18:30:33:SJ cbx_altfp_add_sub 2017:01:11:18:30:33:SJ cbx_altpriority_encoder 2017:01:11:18:30:33:SJ cbx_cycloneii 2017:01:11:18:30:33:SJ cbx_lpm_add_sub 2017:01:11:18:30:33:SJ cbx_lpm_compare 2017:01:11:18:30:33:SJ cbx_mgl 2017:01:11:19:37:47:SJ cbx_nadder 2017:01:11:18:30:33:SJ cbx_stratix 2017:01:11:18:30:33:SJ cbx_stratixii 2017:01:11:18:30:33:SJ  VERSION_END
...
module  div_cycle_14_area_altbarrel_shift_mtd
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[129:104];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		sbit_w = {sbit_piper2d, smux_w[103:78], sbit_piper1d, smux_w[51:0], data},
...
endmodule //div_cycle_14_area_altbarrel_shift_mtd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altbarrel_shift_s0g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //div_cycle_14_area_altbarrel_shift_s0g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //div_cycle_14_area_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //div_cycle_14_area_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	div_cycle_14_area_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	div_cycle_14_area_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //div_cycle_14_area_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	div_cycle_14_area_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	div_cycle_14_area_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
endmodule //div_cycle_14_area_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	div_cycle_14_area_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	div_cycle_14_area_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //div_cycle_14_area_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	div_cycle_14_area_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	div_cycle_14_area_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
...
endmodule //div_cycle_14_area_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	div_cycle_14_area_altpriority_encoder_bv7   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	div_cycle_14_area_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[15:8]),
...
endmodule //div_cycle_14_area_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
	...
	div_cycle_14_area_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	div_cycle_14_area_altpriority_encoder_be8   altpriority_encoder23
	( 
	.data(data[15:8]),
...
endmodule //div_cycle_14_area_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	div_cycle_14_area_altpriority_encoder_uv8   altpriority_encoder10
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder10_q));
	div_cycle_14_area_altpriority_encoder_ue9   altpriority_encoder11
	( 
	.data(data[31:16]),
...
endmodule //div_cycle_14_area_altpriority_encoder_ou8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //div_cycle_14_area_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	div_cycle_14_area_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	div_cycle_14_area_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
...
endmodule //div_cycle_14_area_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_2h9
	( 
	data,
	q,
	zero) ;
	...
	div_cycle_14_area_altpriority_encoder_qh8   altpriority_encoder28
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	div_cycle_14_area_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
...
endmodule //div_cycle_14_area_altpriority_encoder_2h9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_d6b
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	div_cycle_14_area_altpriority_encoder_2h9   altpriority_encoder26
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	div_cycle_14_area_altpriority_encoder_2h9   altpriority_encoder27
	( 
	.data(data[15:8]),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder26_zero, (({3{wire_altpriority_encoder26_zero}} & wire_altpriority_encoder27_q) | ({3{(~ wire_altpriority_encoder26_zero)}} & wire_altpriority_encoder26_q))},
		tmp_zero_wire = (wire_altpriority_encoder26_zero & wire_altpriority_encoder27_zero),
		zero = (~ pipeline_zero_n_dffe);
endmodule //div_cycle_14_area_altpriority_encoder_d6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //div_cycle_14_area_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	div_cycle_14_area_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	div_cycle_14_area_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
endmodule //div_cycle_14_area_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_229
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	div_cycle_14_area_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	div_cycle_14_area_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
endmodule //div_cycle_14_area_altpriority_encoder_229

//synthesis_resources = reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_ena
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	div_cycle_14_area_altpriority_encoder_2h9   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	div_cycle_14_area_altpriority_encoder_229   altpriority_encoder33
	( 
	.data(data[15:8]),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder32_zero, (({3{wire_altpriority_encoder32_zero}} & wire_altpriority_encoder33_q) | ({3{(~ wire_altpriority_encoder32_zero)}} & wire_altpriority_encoder32_q))};
endmodule //div_cycle_14_area_altpriority_encoder_ena

//synthesis_resources = reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altpriority_encoder_dna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	div_cycle_14_area_altpriority_encoder_d6b   altpriority_encoder24
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	div_cycle_14_area_altpriority_encoder_ena   altpriority_encoder25
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //div_cycle_14_area_altpriority_encoder_dna

//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 798 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_cycle_14_area_altfp_add_sub_lil
	( 
	clock,
	dataa,
	datab,
	...
	div_cycle_14_area_altbarrel_shift_mtd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	div_cycle_14_area_altbarrel_shift_s0g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	div_cycle_14_area_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	div_cycle_14_area_altpriority_encoder_dna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) exp_res_dffe32 <= 8'b0;
...
endmodule //div_cycle_14_area_altfp_add_sub_lil
//VALID FILE
...
module div_cycle_14_area (
	...
	div_cycle_14_area_altfp_add_sub_lil	div_cycle_14_area_altfp_add_sub_lil_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_cycle_14_area_bb.v FALSE
