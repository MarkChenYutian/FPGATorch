...
//altfp_exp CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=17 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock data nan overflow result underflow zero
//VERSION_BEGIN 16.1 cbx_altfp_exp 2017:01:11:18:30:33:SJ cbx_altmult_opt 2017:01:11:18:30:33:SJ cbx_cycloneii 2017:01:11:18:30:33:SJ cbx_lpm_add_sub 2017:01:11:18:30:33:SJ cbx_lpm_clshift 2017:01:11:18:30:33:SJ cbx_lpm_compare 2017:01:11:18:30:33:SJ cbx_lpm_mult 2017:01:11:18:30:33:SJ cbx_lpm_mux 2017:01:11:18:30:33:SJ cbx_mgl 2017:01:11:19:37:47:SJ cbx_nadder 2017:01:11:18:30:33:SJ cbx_padd 2017:01:11:18:30:33:SJ cbx_stratix 2017:01:11:18:30:33:SJ cbx_stratixii 2017:01:11:18:30:33:SJ cbx_util_mgl 2017:01:11:18:30:33:SJ  VERSION_END
...
module  exp_cycle_17_altfp_exp_c5f
	( 
	clock,
	data,
	nan,
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) nan_dffe16 <= 1'b0;
		else if  (clk_en == 1'b1)   nan_dffe16 <= nan_wi;
	// synopsys translate_off
	initial
		overflow_dffe16 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) overflow_dffe16 <= 1'b0;
		else if  (clk_en == 1'b1)   overflow_dffe16 <= overflow_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) underflow_dffe16 <= 1'b0;
		else if  (clk_en == 1'b1)   underflow_dffe16 <= underflow_wi;
	// synopsys translate_off
	initial
		x_fixed_dffe_0 = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) zero_dffe16 <= 1'b0;
		else if  (clk_en == 1'b1)   zero_dffe16 <= zero_wi;
	...
	assign
		...
		zero_wi = zero_w,
		zero_wo = zero_dffe16;
endmodule //exp_cycle_17_altfp_exp_c5f
//VALID FILE
...
module exp_cycle_17 (
	...
	exp_cycle_17_altfp_exp_c5f	exp_cycle_17_altfp_exp_c5f_component (
				.clock (clock),
				.data (data),
				.nan (sub_wire0),
				.overflow (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL exp_cycle_17.cmp FALSE TRUE
