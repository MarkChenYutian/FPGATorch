...
//VERSION_BEGIN 16.1 cbx_altbarrel_shift 2017:01:11:18:30:33:SJ cbx_altfp_log 2017:01:11:18:30:33:SJ cbx_altpriority_encoder 2017:01:11:18:30:33:SJ cbx_altsquare 2017:01:11:18:30:33:SJ cbx_cycloneii 2017:01:11:18:30:33:SJ cbx_lpm_add_sub 2017:01:11:18:30:33:SJ cbx_lpm_compare 2017:01:11:18:30:33:SJ cbx_lpm_mult 2017:01:11:18:30:33:SJ cbx_lpm_mux 2017:01:11:18:30:33:SJ cbx_mgl 2017:01:11:19:37:47:SJ cbx_nadder 2017:01:11:18:30:33:SJ cbx_padd 2017:01:11:18:30:33:SJ cbx_stratix 2017:01:11:18:30:33:SJ cbx_stratixii 2017:01:11:18:30:33:SJ cbx_util_mgl 2017:01:11:18:30:33:SJ  VERSION_END
...
//VERSION_BEGIN 16.1 cbx_altbarrel_shift 2017:01:11:18:30:33:SJ cbx_mgl 2017:01:11:19:37:47:SJ  VERSION_END

//synthesis_resources = reg 33 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altbarrel_shift_itd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //log_cycle_21_altbarrel_shift_itd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altbarrel_shift_qab
	( 
	data,
	distance,
	result) ;
...
endmodule //log_cycle_21_altbarrel_shift_qab
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altbarrel_shift_51e
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({32{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[143:128], pad_w[15:0]}) | ({32{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[159:144]})) | ({32{(~ sel_w[4])}} & sbit_w[159:128])), ((({32{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[119:96], pad_w[7:0]}) | ({32{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[127:104]})) | ({32{(~ sel_w[3])}} & sbit_w[127:96])), ((({32{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[91:64], pad_w[3:0]}) | ({32{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[95:68]})) | ({32{(~ sel_w[2])}} & sbit_w[95:64])), ((({32{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[61:32], pad_w[1:0]}) | ({32{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[63:34]})) | ({32{(~ sel_w[1])}} & sbit_w[63:32])), ((({32{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[30:0], pad_w[0]}) | ({32{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[31:1]})) | ({32{(~ sel_w[0])}} & sbit_w[31:0]))};
endmodule //log_cycle_21_altbarrel_shift_51e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_and_or_h9b
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_and_or_h9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_and_or_v6b
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		operation_r2_w = {(operation_r2_w[0] | connection_r1_w[1]), connection_r1_w[0]},
		result = connection_dffe2;
endmodule //log_cycle_21_altfp_log_and_or_v6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_and_or_c8b
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		result = connection_dffe2;
endmodule //log_cycle_21_altfp_log_and_or_c8b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_s0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_s0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_k0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_k0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_0nc
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_cycle_21_altfp_log_csa_0nc
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_d4b
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_cycle_21_altfp_log_csa_d4b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_umc
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_cycle_21_altfp_log_csa_umc
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_nlf
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_nlf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_8kf
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_8kf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_r0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_r0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_o0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_cycle_21_altfp_log_csa_o0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_l1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({15{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({15{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_cycle_21_altfp_log_csa_l1e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_s1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({14{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({14{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_cycle_21_altfp_log_csa_s1e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altfp_log_csa_p1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({13{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({13{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_cycle_21_altfp_log_csa_p1e

//synthesis_resources = lpm_add_sub 27 lpm_mult 4 lpm_mux 5 reg 531 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_range_reduction_uqd
	( 
	a0_in,
	aclr,
	almostlog,
...
`endif
	...
	log_cycle_21_altfp_log_csa_s0e   add0_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_s0e   add0_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_s0e   add0_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_k0e   add1_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_r0e   add1_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_o0e   add1_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_l1e   sub1_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_s1e   sub1_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_p1e   sub1_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //log_cycle_21_range_reduction_uqd


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" LSB_PRIORITY="NO" PIPELINE=1 WIDTH=64 WIDTHAD=6 aclr clk_en clock data q
//VERSION_BEGIN 16.1 cbx_altpriority_encoder 2017:01:11:18:30:33:SJ cbx_mgl 2017:01:11:19:37:47:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //log_cycle_21_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //log_cycle_21_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	log_cycle_21_altpriority_encoder_3v7   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q));
	log_cycle_21_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //log_cycle_21_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	log_cycle_21_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	log_cycle_21_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //log_cycle_21_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	log_cycle_21_altpriority_encoder_6v7   altpriority_encoder12
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder12_q));
	log_cycle_21_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[7:4]),
...
endmodule //log_cycle_21_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	log_cycle_21_altpriority_encoder_6e8   altpriority_encoder18
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	log_cycle_21_altpriority_encoder_6e8   altpriority_encoder19
	( 
	.data(data[7:4]),
...
endmodule //log_cycle_21_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	log_cycle_21_altpriority_encoder_bv7   altpriority_encoder10
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder10_q));
	log_cycle_21_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[15:8]),
...
endmodule //log_cycle_21_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	log_cycle_21_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	log_cycle_21_altpriority_encoder_be8   altpriority_encoder21
	( 
	.data(data[15:8]),
...
endmodule //log_cycle_21_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_cycle_21_altpriority_encoder_r08   altpriority_encoder8
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder8_q));
	log_cycle_21_altpriority_encoder_rf8   altpriority_encoder9
	( 
	.data(data[31:16]),
...
endmodule //log_cycle_21_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	log_cycle_21_altpriority_encoder_rf8   altpriority_encoder22
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	log_cycle_21_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[31:16]),
...
endmodule //log_cycle_21_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_uja
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	log_cycle_21_altpriority_encoder_tv8   altpriority_encoder6
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder6_q));
	log_cycle_21_altpriority_encoder_te9   altpriority_encoder7
	( 
	.data(data[63:32]),
...
endmodule //log_cycle_21_altpriority_encoder_uja
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_cycle_21_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_cycle_21_altpriority_encoder_r08   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q));
	log_cycle_21_altpriority_encoder_rf8   altpriority_encoder25
	( 
	.data(data[31:16]),
...
module  log_cycle_21_altfp_log_n6b
	...
	log_cycle_21_altbarrel_shift_itd   Lshiftsmall
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	log_cycle_21_altbarrel_shift_qab   lzc_norm_L
	( 
	.data({Log_normal_pipe, {17{1'b0}}}),
	.distance((~ wire_lzc_norm_E_q)),
	.result(wire_lzc_norm_L_result));
	log_cycle_21_altbarrel_shift_51e   Rshiftsmall
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_and_or_h9b   exp_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_and_or_v6b   exp_zero
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_and_or_c8b   man_inf
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_and_or_c8b   man_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_s0e   add1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_k0e   add2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_0nc   exp_biase_sub
	( 
	.dataa(exp_data),
	.datab(exp_biase),
	.result(wire_exp_biase_sub_result));
	log_cycle_21_altfp_log_csa_d4b   sub1
	( 
	.dataa({12{1'b0}}),
	.datab(Y0[11:0]),
	.result(wire_sub1_result));
	log_cycle_21_altfp_log_csa_0nc   sub2
	( 
	.dataa({8{1'b0}}),
	.datab(E0),
	.result(wire_sub2_result));
	log_cycle_21_altfp_log_csa_umc   sub3
	( 
	.dataa({1'b0, lzo}),
	.datab({1'b0, pfinal_s}),
	.result(wire_sub3_result));
	log_cycle_21_altfp_log_csa_nlf   sub4
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_8kf   sub5
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_cycle_21_altfp_log_csa_0nc   sub6
	( 
	.dataa(E0offset),
	.datab({{3{1'b0}}, (~ E_normal)}),
	.result(wire_sub6_result));
	log_cycle_21_range_reduction_uqd   range_reduction
	( 
	...
	log_cycle_21_altpriority_encoder_uja   lzc_norm_E
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	.q(wire_lzc_norm_E_q));
	log_cycle_21_altpriority_encoder_q08   lzoc
	( 
...
endmodule //log_cycle_21_altfp_log_n6b
//VALID FILE
...
module log_cycle_21 (
	...
	log_cycle_21_altfp_log_n6b	log_cycle_21_altfp_log_n6b_component (
				.clock (clock),
				.data (data),
				.nan (sub_wire0),
				.result (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL log_cycle_21.cmp FALSE TRUE
